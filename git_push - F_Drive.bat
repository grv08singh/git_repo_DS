...
cd "F:\Grv\Grv\01 GIT\01_masterRepo"
git pull
git add .
...
cd "F:\Grv\Grv\01 GIT\13_Misc_projects"
git pull
git add .
...
cd "F:\Grv\Grv\01 GIT\12_GenAI_projects"
git pull
git add .
...
cd "F:\Grv\Grv\01 GIT\11_NLP_projects"
git pull
git add .
...
cd "F:\Grv\Grv\01 GIT\10_DL_projects"
git pull
git add .
...
cd "F:\Grv\Grv\01 GIT\09_ML_projects"
git pull
git add .
